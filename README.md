...
4. Add one or more classes that implement `IClockworkTaskBase` and a method with the `[Interval(..)]` attribute (see [Examples](https://github.com/derekantrican/ClockworkFramework/tree/master/ClockworkFramework/Examples))
